...
"""
Wired AI 新闻爬虫
来源：https://www.wired.com/category/ai/
RSS: https://www.wired.com/feed/tag/ai
"""
...
class WiredCrawler:
    ...
    def __init__(self):
        self.name = "Wired"
        self.url = "https://www.wired.com/feed/tag/ai"
        self.headers = {
    ...
    def _extract_keywords(self, title, description):
        ...
        stop_words = {'article', 'news', 'story', 'report', 'latest', 'new', 'today', 'wired'}
...
def main():
    ...
    # 保存为 JSON
    if articles:
        output_file = f"logs/wired_{datetime.now().strftime('%Y%m%d')}.json"
