...
# -*- coding: utf-8 -*-
"""
Bing News AI 新闻爬虫（中文）
来源：Bing News - AI 话题
RSS: https://www.bing.com/news/rss?q=AI&cc=CN&setlang=zh-CN
"""
...
class BingNewsCrawler:
    ...
    def __init__(self):
        self.name = "Bing News"
        self.url = "https://www.bing.com/news/rss?q=AI&cc=CN&setlang=zh-CN"
        self.headers = {
    ...
    def fetch(self):
        ...
        try:
            ...
            print(f"✅ 成功抓取 {len(articles)} 条 Bing News AI 新闻")
            return articles
    ...
    def _extract_keywords(self, title, description):
        ...
        stop_words = {'公司', '项目', '产品', '技术', '发展', '发布', '推出', '最新', '新闻', '文章', 'bing', 'news'}
...
def main():
    ...
    # 保存为 JSON
    if articles:
        output_file = f"logs/bing_news_{datetime.now().strftime('%Y%m%d')}.json"
