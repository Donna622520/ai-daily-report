...
# -*- coding: utf-8 -*-
"""
Google News AI 新闻爬虫（中文）
来源：Google News - AI 话题
RSS: https://news.google.com/rss/search?q=AI&hl=zh-CN&gl=CN&ceid=CN:zh-CN
"""
...
class GoogleNewsCrawler:
    ...
    def __init__(self):
        ...
        self.url = "https://news.google.com/rss/search?q=AI&hl=zh-CN&gl=CN&ceid=CN:zh-CN"
        self.headers = {
    ...
    def fetch(self):
        """抓取新闻"""
        print(f"📰 正在抓取 Google News AI 新闻...")
        ...
        try:
            ...
            print(f"✅ 成功抓取 {len(articles)} 条 Google News AI 新闻")
            return articles
    ...
    def _extract_keywords(self, title, description):
        ...
        stop_words = {'公司', '项目', '产品', '技术', '发展', '发布', '推出', '最新', '新闻', '文章', 'google', 'news'}
...
def main():
    ...
    # 保存为 JSON
    if articles:
        output_file = f"logs/google_news_{datetime.now().strftime('%Y%m%d')}.json"
